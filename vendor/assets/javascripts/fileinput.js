...
(function ($) {
    ...
    $.fn.fileinput.locales.ru = {
        ...
        removeTitle: 'Сбросить выделенные файлы',
        cancelLabel: 'Отмена',
        cancelTitle: 'Прервать загрузку',
        uploadLabel: 'Загрузить',
        uploadTitle: 'Загрузить выбранные файлы',
        msgSizeTooLarge: 'Размер файла "{name}" (<b>{size} KB</b>) превышает максимальный размер <b>{maxSize} KB</b>. Пожалуйтста, выберите файл меньшего размера!',
        msgFilesTooLess: 'Выберите не менее <b>{n}</b> {files} файлов. Пожалуйста, выберите файлы заново!',
        msgFilesTooMany: 'Число выбранных файлов <b>({n})</b> превышает максимальное лимит в <b>{m}</b> файлов. Пожалуйста, выполните загрузку повторно!',
        msgFileNotFound: 'Файл "{name}" не найден!',
        msgFileSecured: 'Права доступа к файлу запрещают чтение файла "{name}".',
        msgFileNotReadable: 'Файл "{name}" не читается.',
        msgFilePreviewAborted: 'Предпросмотр файла "{name}" прерван.',
        msgFilePreviewError: 'Ошибка в процессе чтения файла "{name}".',
        msgInvalidFileType: 'Недопустимый тип файла "{name}". Поддерживаются только следующие типы файлов "{types}".',
        msgInvalidFileExtension: 'Недопустимое расширение имени файла "{name}". Поддерживаются только следующие расширения "{extensions}".',
        msgValidationError: 'Ошибка в процессе загрузки файла',
        msgLoading: 'Загружается файл {index} из {files} &hellip;',
        msgProgress: 'Загружается файл {index} из {files} - {name} - {percent}% загружено.',
        msgSelected: '{n} {files} выбрано',
        msgFoldersNotAllowed: 'Тяните и бросайте только файлы! {n} папок пропущено.',
        dropZoneTitle: 'Тяните и бросайте файлы сюда &hellip;'
    };
