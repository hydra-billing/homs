...
import SubmitSelect from './form/submit_select.js';
import User from './form/user.js';
import String from './form/string.js';
import Text from './form/text.js';
import Checkbox from './form/checkbox.js';
import Static from './form/static.js';
import SelectTable from './form/select_table.js';
import FileUpload from './form/file_upload.js';
import RadioButton from './form/radio_button.js';
...
const FormWrapped = compose(withCallbacks, withErrorBoundary)(Form);
