modulejs.define('HBWFormDatetime', ['React', 'ReactDOM', 'jQuery', 'moment', 'HBWDeleteIfMixin'], (React, ReactDOM, jQuery, moment, DeleteIfMixin) => React.createClass({
