...
import SubmitSelect from './submit_select.js';
...
import SelectTable from './select_table.js';
...
class FormGroup extends Component {
  ...
  formControl = (name, params) => {
    ...
    const Group = compose(withConditions, withErrorBoundary)(FormGroup);
...
const FormGroupWrapped = compose(withConditions, withErrorBoundary)(FormGroup);

export default FormGroupWrapped;
