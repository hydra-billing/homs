    ...
    @with_all_controls = {
      ...
      fields: [
        ...
        },
        {
          ...
          css_class: 'col-xs-12'
          options: [
            { name: 'Не пользовался',  value: 'Не пользовался',  css_class: 'btn btn-primary'},
            { name: 'Offline Telecom', value: 'Offline Telecom', css_class: 'btn btn-warning'},
            { name: 'Goodlife',        value: 'Goodlife',        css_class: 'btn btn-primary'},
            { name: 'ОчХорИнтернет',   value: 'ОчХорИнтернет',   css_class: 'btn btn-warning'},
            { name: 'Вектор',          value: 'Вектор',          css_class: 'btn btn-primary'},
            { name: 'Азимут',          value: 'Азимут',          css_class: 'btn btn-warning'},
            { name: 'Другое',          value: 'Другое',          css_class: 'btn btn-primary'},
          ]
        }
      ]
    }
